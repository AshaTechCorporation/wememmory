    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // --- รายการที่ 1: สั่งพิมพ์ (ใช้รูปภาพ) ---
          _HistoryCard(
            title: 'อัลบั้ม',
          ...
          // --- รายการที่ 2: ที่ต้องได้รับ (ใช้รูปภาพ) ---
          _HistoryCard(
            title: 'อัลบั้ม',
          ...
          // --- รายการที่ 3: สำเร็จ (ใช้ Icon ปกติ) ---
          _HistoryCard(
            title: 'อัลบั้ม',
            statusText: 'สำเร็จ',
            barCount: 4,
          ...
          // --- รายการที่ 4: คืนสินค้า (ใช้รูปภาพ) ---
          _HistoryCard(
            title: 'อัลบั้ม',
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                // ✅ แก้ไข: ใช้ Stack เพื่อแสดงรูปภาพซ้อนกันและเอียง
                SizedBox(
                  width: 90, 
                  height: 80,
                  child: Stack(
